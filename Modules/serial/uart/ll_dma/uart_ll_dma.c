...
static void UART_vidIrqCallback(const UART_t * const psUart)
{
    ...
    /*  check IDLE flag  */
    if(LL_USART_IsEnabledIT_IDLE(psUart->uart_handle) &&
            LL_USART_IsActiveFlag_IDLE(psUart->uart_handle))
    {
