...
/**
 * Each task's call stack max cost is 160, 168 bytes (from the static analyzer)
 * That translates to 160/4 = 40 words in the stack
 * Plus task context block, so roughly around 64 words for each task
 * */
#ifdef CONF_UART_RTOS_TX_TASK_STACK_WORDS
#define UART_RTOS_TX_TASK_STACK_WORDS     CONF_UART_RTOS_TX_TASK_STACK_WORDS
#else 
#define UART_RTOS_TX_TASK_STACK_WORDS     64
#endif /* CONF_UART_RTOS_TX_TASK_STACK_WORDS  */

#ifdef CONF_UART_RTOS_RX_TASK_STACK_WORDS
#define UART_RTOS_RX_TASK_STACK_WORDS     CONF_UART_RTOS_RX_TASK_STACK_WORDS
#else 
#define UART_RTOS_RX_TASK_STACK_WORDS     64
#endif /* CONF_UART_RTOS_RX_TASK_STACK_WORDS  */
